...
type LayoutRouteId = RouteId | "/" | "/change-password" | "/files" | "/jobs/[id]" | "/login" | "/logs" | "/logs/[job_id]" | "/notifications" | "/settings" | "/setup" | "/transcoder" | null
type LayoutParams = RouteParams & { id?: string | undefined; job_id?: string | undefined }
