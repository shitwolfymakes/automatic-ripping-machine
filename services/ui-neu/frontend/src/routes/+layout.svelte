			...
			<div class="hidden lg:flex items-center gap-3 text-sm">
				...
				<div class="flex items-center gap-3 text-xs">
					...
					{#if $dashboard.active_transcodes.length > 0}
						<a in:reveal href="/transcoder" class="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors dark:text-indigo-400 dark:hover:text-indigo-300">{$dashboard.active_transcodes.length} transcoding</a>
					{/if}
