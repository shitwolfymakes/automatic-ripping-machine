<script lang="ts">
	...
	import TranscodePresetsSection from '$lib/components/TranscodePresetsSection.svelte';
	import SessionsSection from '$lib/components/SessionsSection.svelte';
	...
	const screenTabs = ['rip-presets', 'transcode-presets', 'sessions', 'transcoding', 'notifications', 'appearance', 'drives', 'system'] as const;
	...
	const TAB_LABELS: Record<string, string> = {
		'rip-presets': 'Rip Presets',
		'transcode-presets': 'Transcode Presets',
		sessions: 'Sessions',
...
<div class="space-y-6 pb-20">
	...
	>
		...
		{#if activeTab === 'transcode-presets'}
			<TranscodePresetsSection />
		{/if}
