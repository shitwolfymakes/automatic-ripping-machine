...
def _settings(**over):
    base = dict(ARM_DRIVE_DEV="/dev/sr0", ARM_DRIVE_ID="drv_test", ARM_BACKEND_URL="https://b", ARM_SERVICE_TOKEN="t")
    base.update(over)
...
def test_tunables_overridable(monkeypatch):
    ...
    s = Settings(ARM_DRIVE_DEV="/dev/sr0", ARM_DRIVE_ID="drv_test", ARM_BACKEND_URL="https://b", ARM_SERVICE_TOKEN="t")  # type: ignore[arg-type]
