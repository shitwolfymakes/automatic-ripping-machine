...
|-----------|-----------------------------------|----------------------------------|---------------------------------------------------------------|---------------|----------------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| BD        | *Big Buck Bunny* (2008)           | `job_01KT5H0GB1M705C43Z91FX6WDG` | TMDB movie, hit clean                                         | 6/6           | 6/6 H.265 1080p (CPU)      | 1.8 GB     | First end-to-end Blu-ray smoke on the dev stack (LG BP50NB40 USB BD/CD drive). Rip 547 s, transcode 477 s, ~17 min insert→terminal. 6.6 GB raw → 1.8 GB transcoded (73 % reduction). **Drive quirk:** `CDROM_DRIVE_STATUS` ioctl stuck at `DRIVE_NOT_READY` despite a readable disc; bypassed via `POST /api/jobs/manual` (heartbeat-fed `media_status=loaded` satisfied the gate). Worth tracking — same drive that motivated Phase 15.5. Output at `media/Big Buck Bunny (2008)/Big Buck Bunny (2008) - Track NN - plex-1080p-h-265.mkv`. |
| DVD       |                                   |                                  |                                                               |               |                            |            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
